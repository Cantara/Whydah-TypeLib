...
public class Validator {
    ...
    public static final String DEFAULT_SENSIBLE_USERNAME = "^[a-zæøåA-ZÆØÅ0-9\\p{L}\\s_.]+$";
    ...
    public static final String DEFAULT_SENSIBLE_PERSON_NAME = "^[a-zøæåA-ZÆØÅ]+(([',. -][a-zæøåA-ZÆØÅ ])?[a-zæøåA-ZÆØÅ]*)*$";
