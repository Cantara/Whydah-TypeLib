...
public class ValidatorTest {
	...
	public void test_isValidTextInput_phoneNumber() throws Exception {
		...
		//Invalid ones
		assertFalse(Validator.isValidTextInput("-91905054", 1, 100, Validator.DEFAULT_PHONE_NUMBER_PATTERN));
		assertFalse(Validator.isValidTextInput("91+9-05054", 1, 100, Validator.DEFAULT_PHONE_NUMBER_PATTERN));
